<h2><a href="https://www.geeksforgeeks.org/problems/area-of-a-triangle5739/1?page=6&category=Mathematical&sortBy=submissions">Area of a triangle</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size:18px">Given three sides of a triangle A, B and C in the form of integers. Find the area of the triangle.<br>
